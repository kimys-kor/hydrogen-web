...
import BlogList from 'views/pages/blog/BlogList';
import BlocksDetails from 'views/blocks/details/Details';
...
import HorizontalMenuPage from 'views/interface/content/menu/Horizontal';
import VerticalMenuPage from 'views/interface/content/menu/Vertical';
import VerticalHiddenMenuPage from 'views/interface/content/menu/VerticalHidden';
import VerticalNoHiddenMenuPage from 'views/interface/content/menu/VerticalNoHidden';
import MobileOnlyMenuPage from 'views/interface/content/menu/MobileOnly';
import MiscellaneousFaq from 'views/pages/miscellaneous/Faq';
import MiscellaneousKnowledgeBase from 'views/pages/miscellaneous/KnowledgeBase';
import MiscellaneousMailing from 'views/pages/miscellaneous/Mailing';
import MiscellaneousPricing from 'views/pages/miscellaneous/Pricing';
import MiscellaneousSearch from 'views/pages/miscellaneous/Search';
import PortfolioHome from 'views/pages/portfolio/PortfolioHome';
import PortfolioDetail from 'views/pages/portfolio/PortfolioDetail';
...
const pages = {
  ...
  blog: {
    ...
    home: BlogHome, // lazy(() => import(views/pages/blog/BlogHome')),
    grid: BlogGrid, // lazy(() => import(views/pages/blog/BlogGrid')),
    list: BlogList, // lazy(() => import(views/pages/blog/BlogList')),
    detail:BlogDetail, // lazy(() => import(views/pages/blog/BlogDetail')),
  },
  miscellaneous: {
    index: lazy(() => import('views/pages/miscellaneous/Miscellaneous')),
    faq: MiscellaneousFaq, // lazy(() => import(views/pages/miscellaneous/Faq')),
    knowledgeBase: MiscellaneousKnowledgeBase, //  lazy(() => import(views/pages/miscellaneous/KnowledgeBase')),
    error: lazy(() => import('views/pages/miscellaneous/Error')),
    comingSoon: lazy(() => import('views/pages/miscellaneous/ComingSoon')),
    pricing: MiscellaneousPricing, //  lazy(() => import(views/pages/miscellaneous/Pricing')),
    search: MiscellaneousSearch, //lazy(() => import(views/pages/miscellaneous/Search')),
    mailing:MiscellaneousMailing, //  lazy(() => import(views/pages/miscellaneous/Mailing')),
    empty: lazy(() => import('views/pages/miscellaneous/Empty')),
  },
  portfolio: {
    index: lazy(() => import('views/pages/portfolio/Portfolio')),
    home: PortfolioHome, // lazy(() => import(views/pages/portfolio/PortfolioHome')),
    detail: PortfolioDetail, // lazy(() => import(views/pages/portfolio/PortfolioDetail')),
  },
  profile: {
...
const blocks = {
  ...
  details: BlocksDetails, //  lazy(() => import(views/blocks/details/Details')),
...
const interfaces = {
  ...
  content: {
    ...
    menu: {
      ...
      horizontal: HorizontalMenuPage, // lazy(() => import(views/interface/content/menu/Horizontal')),
      vertical: VerticalMenuPage, //lazy(() => import(views/interface/content/menu/Vertical')),
      verticalHidden: VerticalHiddenMenuPage, //  lazy(() => import(views/interface/content/menu/VerticalHidden')),
      verticalNoHidden: VerticalNoHiddenMenuPage, // lazy(() => import(views/interface/content/menu/VerticalNoHidden')),
      mobileOnly:MobileOnlyMenuPage, // lazy(() => import(views/interface/content/menu/MobileOnly')),
...
const routesAndMenuItems = {
  mainMenuItems: [
    ...
    },
    {
      ...
      subs: [
        { path: '/default', label: 'setting', component: blocks.cta },
      ],
    },
    {
