        ...
        <Col>
          ...
          <section className="scroll-section" id="images">
            ...
            <Row>
              <Col md="4" sm="6" lg="4" xl="3" xxl="2" xs="12">
                <Card className="mb-5">
                  <Card.Img src="/img/product/small/product-1.jpg" variant="top" alt="card image" />
                  <Card.Body>
              ...
              <Col md="4" sm="6" lg="4" xl="3" xxl="2" xs="12">
                <Card className="mb-5">
                  ...
                  <Card.Img src="/img/product/small/product-1.jpg" variant="bottom" alt="card image" />
                </Card>
              </Col>
              <Col md="6" sm="8" lg="6" xl="4" xxl="3" xs="12">
                <Card className="mb-5" text="white" bg="dark">
                  <img src="/img/product/small/product-1.jpg" className="card-img" alt="card image" />
                ...
                <Card className="mb-5">
                  <Row className="g-0 h-auto sh-md-25">
                    <Col sm="4" className="h-100">
                      <Card.Img src="/img/product/small/product-2.jpg" className="card-img-horizontal-sm" alt="card image" />
                    </Col>
                    <Col sm="8">
                ...
                <Card className="mb-5">
                  <Row className="g-0 sh-13">
                    <Col xs="2" sm="3" className="h-100">
                      <Card.Img src="/img/product/small/product-2.jpg" alt="product-2" className="card-img-horizontal" />
                    </Col>
                    <Col xs="10" sm="9">
                      <Card.Body className="d-flex flex-column">
            ...
            <Card className="mb-5">
              <Row className="g-0 sh-10">
                <Col xs="2" lg="1" className="d-flex align-items-center h-100">
                  <Card.Img src="/img/product/small/product-2.jpg" alt="card image" className="card-img-horizontal" />
                </Col>
          ...
          <section className="scroll-section" id="kitchenSink">
            ...
            <Card className="mb-5 sw-30">
              <Card.Img variant="top" src="/img/product/small/product-3.jpg" alt="card image" />
              <Card.Body>
                <Card.Title>Card title</Card.Title>
              ...
              <Row xs="1" sm="2" xl="4" className="g-4">
                <Col>
                  <Card className="h-100">
                    <Card.Img variant="top" src="/img/product/small/product-4.jpg" alt="image" />
                    <Card.Body>
                      <Card.Title>Card title</Card.Title>
                      <Card.Text>
          ...
          <section className="scroll-section" id="masonryCards">
            ...
            <Masonry breakpointCols={{ default: 4, 1200: 2, 576: 1 }} className="row row-cols-1 row-cols-sm-2 row-cols-xl-4 g-4" columnClassName="col">
              <Card className="mb-4">
                <Card.Img variant="top" src="/img/product/small/product-1.jpg" className="sh-30" alt="image" />
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
                  <Card.Text>
                    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
              ...
              <Card className="mb-4">
                <Card.Img variant="top" src="/img/product/small/product-2.jpg" className="sh-15" alt="image" />
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
                  <Card.Text>
                    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
              ...
              <Card className="mb-4">
                <Card.Img variant="top" src="/img/product/small/product-3.jpg" className="sh-30" alt="image" />
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
                  <Card.Text>This is a longer card with supporting text below as a natural lead-in to additional content.</Card.Text>
                </Card.Body>
              ...
              <Card className="mb-4">
                <Card.Img variant="top" src="/img/product/small/product-9.jpg" className="sh-20" alt="image" />
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
                  <Card.Text>
                    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
              ...
              <Card className="mb-4">
                <Card.Img variant="top" src="/img/product/small/product-5.jpg" className="sh-20" alt="image" />
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
                  <Card.Text>
                    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
              ...
              <Card className="mb-4">
                <Card.Img variant="top" src="/img/product/small/product-6.jpg" className="sh-15" alt="image" />
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
                  <Card.Text>
                    This is a longer card with supporting text below as a natural lead-in to additional content. This content is a little bit longer.
              ...
              <Card className="mb-4">
                <Card.Img variant="top" src="/img/product/small/product-7.jpg" className="sh-15" alt="image" />
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
                  <Card.Text>This is a longer card with supporting text below as a natural lead-in to additional content.</Card.Text>
                </Card.Body>
              ...
              <Card className="mb-4">
                <Card.Img variant="top" src="/img/product/small/product-8.jpg" className="sh-20" alt="image" />
                <Card.Body>
                  <Card.Title>Card title</Card.Title>
