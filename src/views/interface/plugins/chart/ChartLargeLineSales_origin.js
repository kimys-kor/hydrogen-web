...
const ChartLargeLineSales = () => {
  ...
  const data = React.useMemo(() => {
    return {
      labels: [' ', 'Tuesday', 'Wednesday', 'Thursday', 'Today'],
      datasets: [
        {
          label: 'Sales',
          data: [23, 300, 26, 30, 27],
  ...
  return (
    <>
      <Col xs="12" sm="auto" className="d-flex flex-column justify-content-between custom-tooltip pe-0 pe-sm-4">
        <p className="heading title mb-1">123.456.789</p>
        <div ref={tooltipRef} />
        <Row>
          <Col xs="auto">
            <div className="cta-3 text-alternate">34</div>
            <div className="text-small text-muted mb-1">평균(ppm)</div>
          </Col>
          <Col>
            <div className="cta-3 text-alternate">3</div>
            <div className="text-small text-muted mb-1">평균(%)</div>
          </Col>
        </Row>
      </Col>
