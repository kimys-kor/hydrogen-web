      ...
      <Row>
          ...
          <div className="mb-n2">
              ...
              <Row className="g-0 sh-14 sh-md-10">
                <Col xs="auto" className="h-100">
                  <NavLink to="/pages/portfolio/detail">
                    <img src="/img/product/small/product-1.jpg" alt="user" className="card-img card-img-horizontal sw-13 sw-md-12" />
                  </NavLink>
                </Col>
                <Col>
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col xs="auto" className="h-100">
                  <NavLink to="/pages/portfolio/detail">
                    <img src="/img/product/small/product-2.jpg" alt="user" className="card-img card-img-horizontal sw-13 sw-md-12" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col xs="auto" className="h-100">
                  <NavLink to="/pages/portfolio/detail">
                    <img src="/img/product/small/product-3.jpg" alt="user" className="card-img card-img-horizontal sw-13 sw-md-12" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col xs="auto" className="h-100">
                  <NavLink to="/pages/portfolio/detail">
                    <img src="/img/product/small/product-4.jpg" alt="user" className="card-img card-img-horizontal sw-13 sw-md-12" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-14 sh-md-10">
                <Col xs="auto" className="h-100">
                  <NavLink to="/pages/portfolio/detail">
                    <img src="/img/product/small/product-5.jpg" alt="user" className="card-img card-img-horizontal sw-13 sw-md-12" />
                  </NavLink>
                </Col>
                <Col>
                  <Card.Body className="pt-0 pb-0 h-100">
        ...
        <Col lg="4">
          ...
          <Card className="w-100 sh-50 mb-5">
            <img src="/img/banner/cta-square-4.jpg" className="card-img h-100" alt="card image" />
      ...
      <Row className="g-2 mb-5">
        <Col sm="6" xl="3">
          <Card className="w-100 sh-23 hover-img-scale-up">
            <img src="/img/banner/cta-vertical-1.jpg" className="card-img h-100 scale" alt="card image" />
            <div className="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
              <div className="d-flex flex-column h-100 justify-content-between align-items-start">
        ...
        <Col sm="6" xl="3">
          <Card className="w-100 sh-23 hover-img-scale-up">
            <img src="/img/banner/cta-vertical-2.jpg" className="card-img h-100 scale" alt="card image" />
            <div className="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
              <div className="d-flex flex-column h-100 justify-content-between align-items-start">
        ...
        <Col sm="6" xl="3">
          <Card className="w-100 sh-23 hover-img-scale-up">
            <img src="/img/banner/cta-vertical-4.jpg" className="card-img h-100 scale" alt="card image" />
            <div className="card-img-overlay d-flex flex-column justify-content-between bg-transparent">
              <div className="d-flex flex-column h-100 justify-content-between align-items-start">
                <div className="cta-2 text-black w-75">Introduction to Bread Making</div>
                <Button variant="primary" className="btn-icon btn-icon-start mt-3 stretched-link">
          ...
          <Card className="h-100-card mb-n2">
            <Card.Body>
              <Row className="g-0 sh-10 sh-sm-7 mb-2">
                <Col xs="auto">
                  <img src="/img/profile/profile-1.jpg" className="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                </Col>
                <Col>
              ...
              <Row className="g-0 sh-10 sh-sm-7 mb-2">
                <Col xs="auto">
                  <img src="/img/profile/profile-2.jpg" className="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                </Col>
                <Col>
                  <div className="d-flex flex-column flex-sm-row ps-4 h-100 align-items-sm-center justify-content-sm-between">
                    <div className="d-flex flex-column mb-2 mb-sm-0">
              ...
              <Row className="g-0 sh-10 sh-sm-7 mb-2">
                <Col xs="auto">
                  <img src="/img/profile/profile-3.jpg" className="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                </Col>
                <Col>
                  <div className="d-flex flex-column flex-sm-row ps-4 h-100 align-items-sm-center justify-content-sm-between">
                    <div className="d-flex flex-column mb-2 mb-sm-0">
              ...
              <Row className="g-0 sh-10 sh-sm-7 mb-2">
                <Col xs="auto">
                  <img src="/img/profile/profile-4.jpg" className="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                </Col>
                <Col>
                  <div className="d-flex flex-column flex-sm-row ps-4 h-100 align-items-sm-center justify-content-sm-between">
                    <div className="d-flex flex-column mb-2 mb-sm-0">
              ...
              <Row className="g-0 sh-10 sh-sm-7 mb-2">
                <Col xs="auto">
                  <img src="/img/profile/profile-5.jpg" className="card-img rounded-xl sh-6 sw-6" alt="thumb" />
                </Col>
                <Col>
                  <div className="d-flex flex-column flex-sm-row ps-4 h-100 align-items-sm-center justify-content-sm-between">
                    <div className="d-flex flex-column mb-2 mb-sm-0">
          ...
          <div className="mb-n2">
            <Card className="mb-2">
              <Row className="g-0 sh-17 sh-lg-10">
                <Col xs="auto h-100">
                  <img src="/img/product/small/product-1.jpg" alt="user" className="card-img card-img-horizontal h-100 sw-lg-11 sw-14" />
                </Col>
                <Col>
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-17 sh-lg-10">
                <Col xs="auto h-100">
                  <img src="/img/product/small/product-2.jpg" alt="user" className="card-img card-img-horizontal h-100 sw-lg-11 sw-14" />
                </Col>
                <Col>
                  <Card.Body className="h-100 px-4 py-0">
                    <Row className="g-0 h-100 align-content-center">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-17 sh-lg-10">
                <Col xs="auto h-100">
                  <img src="/img/product/small/product-3.jpg" alt="user" className="card-img card-img-horizontal h-100 sw-lg-11 sw-14" />
                </Col>
                <Col>
                  <Card.Body className="h-100 px-4 py-0">
                    <Row className="g-0 h-100 align-content-center">
            ...
            <Card className="mb-2">
              <Row className="g-0 sh-17 sh-lg-10">
                <Col xs="auto h-100">
                  <img src="/img/product/small/product-4.jpg" alt="user" className="card-img card-img-horizontal h-100 sw-lg-11 sw-14" />
                </Col>
                <Col>
                  <Card.Body className="h-100 px-4 py-0">
                    <Row className="g-0 h-100 align-content-center">
