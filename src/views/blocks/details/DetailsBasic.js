...
const DetailsBasic = () => {
  ...
  return (
    <>
      <Card>
        <Card.Img src="/img/product/large/product-1.jpg" variant="top" className="sh-50 cursor-pointer" alt="card image" onClick={() => setIsOpen(true)} />
        <Card.Body>
      ...
      {isOpen && (
        <Lightbox
          mainSrc="/img/product/large/product-1.jpg"
