  ...
  return (
    <div className="mb-n2">
      <Card className="mb-2">
        <Row className="g-0 h-auto sh-sm-18">
          <Col xs="12" sm="auto" className="h-100">
            <img src="/img/product/small/product-1.jpg" alt="product" className="card-img card-img-horizontal-sm sh-24 h-sm-100 sw-sm-18" />
          </Col>
      ...
      <Card className="mb-2">
        <Row className="g-0 h-auto sh-sm-18">
          <Col xs="12" sm="auto" className="h-100">
            <img src="/img/product/small/product-2.jpg" alt="product" className="card-img card-img-horizontal-sm sh-24 h-sm-100 sw-sm-18" />
          </Col>
          <Col xs="12" className="col-sm">
            <Card.Body className="h-100">
              <NavLink to="#" className="d-flex flex-column mb-lg-0 mb-3 mb-lg-0 pe-3">
      ...
      <Card className="mb-2">
        <Row className="g-0 h-auto sh-sm-18">
          <Col xs="12" sm="auto" className="h-100">
            <img src="/img/product/small/product-3.jpg" alt="product" className="card-img card-img-horizontal-sm sh-24 h-sm-100 sw-sm-18" />
          </Col>
          <Col xs="12" className="col-sm">
            <Card.Body className="h-100">
              <NavLink to="#" className="d-flex flex-column mb-lg-0 mb-3 mb-lg-0 pe-3">
