      ...
      <Card.Body className="mb-n3">
          ...
          <Col xs="auto" className="d-flex align-items-center mb-md-0">
            <div className="sw-12">
              <div className="sw-4 mb-1 d-inline-block">
                <img src="/img/profile/profile-1.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 mb-1 d-inline-block ms-n3">
                <img src="/img/profile/profile-2.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
        ...
        <Row className="g-0 align-items-start align-content-start align-content-md-center align-items-md-center sh-13 sh-md-5 mb-3">
          <Col xs="auto" className="d-flex align-items-center mb-md-0">
            <div className="sw-12">
              <div className="sw-4 mb-1 d-inline-block">
                <img src="/img/profile/profile-3.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 mb-1 d-inline-block ms-n3">
                <img src="/img/profile/profile-4.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 sh-4 ms-n3 bg-separator-light d-inline-flex justify-content-center align-items-center rounded-xl">
        ...
        <Row className="g-0 align-items-start align-content-start align-content-md-center align-items-md-center sh-13 sh-md-5 mb-3">
          <Col xs="auto" className="d-flex align-items-center mb-md-0">
            <div className="sw-12">
              <div className="sw-4 mb-1 d-inline-block">
                <img src="/img/profile/profile-5.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 mb-1 d-inline-block ms-n3">
                <img src="/img/profile/profile-6.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 sh-4 ms-n3 bg-separator-light d-inline-flex justify-content-center align-items-center rounded-xl">
        ...
        <Row className="g-0 align-items-start align-content-start align-content-md-center align-items-md-center sh-13 sh-md-5 mb-3">
          <Col xs="auto" className="d-flex align-items-center mb-md-0">
            <div className="sw-12">
              <div className="sw-4 mb-1 d-inline-block">
                <img src="/img/profile/profile-7.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 mb-1 d-inline-block ms-n3">
                <img src="/img/profile/profile-8.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 sh-4 ms-n3 bg-separator-light d-inline-flex justify-content-center align-items-center rounded-xl">
        ...
        <Row className="g-0 align-items-start align-content-start align-content-md-center align-items-md-center sh-13 sh-md-5 mb-3">
          <Col xs="auto" className="d-flex align-items-center mb-md-0">
            <div className="sw-12">
              <div className="sw-4 mb-1 d-inline-block">
                <img src="/img/profile/profile-9.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 mb-1 d-inline-block ms-n3">
                <img src="/img/profile/profile-10.jpg" className="img-fluid rounded-xl border border-2 border-foreground" alt="thumb" />
              </div>
              <div className="sw-4 sh-4 ms-n3 bg-separator-light d-inline-flex justify-content-center align-items-center rounded-xl">
                <div className="fw-bold text-small text-primary cursor-default">1+</div>
              </div>
