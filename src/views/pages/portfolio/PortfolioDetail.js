          ...
          <Row className="g-3">
            <Col xs="12" sm="6" xl="12">
              <Card className="sh-25 hover-img-scale-up hover-reveal">
                <img src="/img/product/small/product-2.jpg" className="card-img h-100 scale" alt="card image" />
            ...
            <Col xs="12" sm="6" xl="12">
              <Card className="sh-25 hover-img-scale-up hover-reveal">
                <img src="/img/product/small/product-3.jpg" className="card-img h-100 scale" alt="card image" />
                <div className="card-img-overlay d-flex flex-column justify-content-between reveal-content">
                  <Row className="g-0">
                    <Col xs="auto" className="pe-3">
                      <CsLineIcons icon="eye" className="text-white me-1" size="15" />
            ...
            <Col xs="12" sm="6" xl="12">
              <Card className="sh-25 hover-img-scale-up hover-reveal">
                <img src="/img/product/small/product-4.jpg" className="card-img h-100 scale" alt="card image" />
                <div className="card-img-overlay d-flex flex-column justify-content-between reveal-content">
                  <Row className="g-0">
                    <Col xs="auto" className="pe-3">
                      <CsLineIcons icon="eye" className="text-white me-1" size="15" />
            ...
            <Col xs="12" sm="6" xl="12">
              <Card className="sh-25 hover-img-scale-up hover-reveal">
                <img src="/img/product/small/product-5.jpg" className="card-img h-100 scale" alt="card image" />
                <div className="card-img-overlay d-flex flex-column justify-content-between reveal-content">
                  <Row className="g-0">
                    <Col xs="auto" className="pe-3">
                      <CsLineIcons icon="eye" className="text-white me-1" size="15" />
