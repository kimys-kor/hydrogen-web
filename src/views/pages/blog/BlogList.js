        ...
        <Col xl="8" xxl="9" className="mb-5">
          ...
          <Card className="mb-5">
            <NavLink to="/pages/blog/detail">
              <img src="/img/product/large/product-1.jpg" className="card-img-top sh-35" alt="card image" />
            </NavLink>
            <Card.Body>
              <h4 className="mb-3">
          ...
          <Card className="mb-5">
            <NavLink to="/pages/blog/detail">
              <img src="/img/product/large/product-2.jpg" className="card-img-top sh-35" alt="card image" />
            </NavLink>
            <Card.Body>
              <h4 className="mb-3">
          ...
          <Card className="mb-5">
            <NavLink to="/pages/blog/detail">
              <img src="/img/product/large/product-3.jpg" className="card-img-top sh-35" alt="card image" />
            </NavLink>
            <Card.Body>
              <h4 className="mb-3">
          ...
          <Card className="mb-5">
            <NavLink to="/pages/blog/detail">
              <img src="/img/product/large/product-4.jpg" className="card-img-top sh-35" alt="card image" />
            </NavLink>
            <Card.Body>
              <h4 className="mb-3">
