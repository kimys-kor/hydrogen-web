          ...
          <Row className="row-cols-1 row-cols-sm-2 row-cols-xl-3 g-2 mb-5">
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-1.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-2.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-3.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-4.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
                      A Complete Guide to Mix Dough for the Molds
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-5.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-6.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-7.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-8.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-9.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
            ...
            <Col>
              <Card className="h-100">
                <Card.Img src="/img/product/small/product-10.jpg" className="card-img-top sh-19" alt="card image" />
                <Card.Body>
                  <NavLink to="/pages/blog/detail" className="body-link stretched-link d-block heading sh-8 mb-0 sh-md-6 d-block h5 heading lh-1-5">
                    <Clamp tag="span" clamp="2">
              ...
              <Row className="mb-n2">
                  ...
                  <Card className="sh-11 sh-sm-14">
                    <Row className="g-0 h-100">
                      <Col className="col-auto">
                        <img src="/img/product/small/product-3.jpg" alt="user" className="card-img card-img-horizontal sw-10 sw-sm-14" />
                      </Col>
                      <Col>
                ...
                <Col md="6" xl="12" className="mb-2">
                  <Card className="sh-11 sh-sm-14">
                    <Row className="g-0 h-100">
                      <Col className="col-auto">
                        <img src="/img/product/small/product-4.jpg" alt="user" className="card-img card-img-horizontal sw-10 sw-sm-14" />
                      </Col>
                      <Col>
                        <Card.Body className="d-flex flex-column pt-0 pb-0 h-100 justify-content-center">
                          <NavLink to="/pages/blog/detail" className="body-link stretched-link">
                ...
                <Col md="6" xl="12" className="mb-2">
                  <Card className="sh-11 sh-sm-14">
                    <Row className="g-0 h-100">
                      <Col className="col-auto">
                        <img src="/img/product/small/product-5.jpg" alt="user" className="card-img card-img-horizontal sw-10 sw-sm-14" />
                      </Col>
                      <Col>
                        <Card.Body className="d-flex flex-column pt-0 pb-0 h-100 justify-content-center">
                          <NavLink to="/pages/blog/detail" className="body-link stretched-link">
                ...
                <Col md="6" xl="12" className="mb-2">
                  <Card className="sh-11 sh-sm-14">
                    <Row className="g-0 h-100">
                      <Col className="col-auto">
                        <img src="/img/product/small/product-7.jpg" alt="user" className="card-img card-img-horizontal sw-10 sw-sm-14" />
                      </Col>
                      <Col>
                        <Card.Body className="d-flex flex-column pt-0 pb-0 h-100 justify-content-center">
                          <NavLink to="/pages/blog/detail" className="body-link stretched-link">
