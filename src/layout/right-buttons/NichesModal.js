        ...
        <Modal.Body>
          <OverlayScrollbarsComponent options={{ overflowBehavior: { x: 'hidden', y: 'scroll' } }} className="scroll-track-visible">
            <Niche
              ...
              img="https://acorn.coloredstrategies.com/img/page/classic-dashboard.jpg"
              urls={{
            ...
            <Niche
              ...
              img="https://acorn.coloredstrategies.com/img/page/ecommerce-platform.jpg"
              urls={{
            ...
            <Niche
              ...
              img="https://acorn.coloredstrategies.com/img/page/service-provider.jpg"
              urls={{
            ...
            <Niche
              ...
              img="https://acorn.coloredstrategies.com/img/page/starter-project.jpg"
              urls={{
